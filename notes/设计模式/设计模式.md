...
- **缺点：** 由于工厂类集中了所有实例的创建逻辑，所以“高内聚”方面做的并不好。另外，当系统中的具体产品类不断增多时，可能会出现要求工厂类也要做相应的修改，扩展性并不很好
...
<img src="../../pics//c79da808-0f28-4a36-bc04-33ccc5b83c13.png"/>
...
封装一个对象的构造过程，并允许按步骤构造。即，将一个复杂对象的构建与它的表示分离，使得同样的构建过程可以创建不同的表示
...
效率不是一个关键问题最高效的解释器通常不是通过直接解释语法分析树实现的, 而是首先将它们转换成另一种形式。例如，正则表达式通常被转换成状态机。但即使在这种情况下, 转换器仍可用解释器模式实现,该模式仍有用
...
<img src="../../pics//b0f61ac2-a4b6-4042-9cf0-ccf4238c1ff7.png"/>
...
public class Client {
    public static void main(String[] args) {
        ...
        Mediator mediator = new ConcreteMediator(alarm, coffeePot, 
                                                 calender, sprinkler);
...
<img src="../../pics//1fc969e4-0e7c-441b-b53c-01950d2f2be5.png"/>
...
<img src="../../pics//ec923dc7-864c-47b0-a411-1f2c48d084de.png"/>
...
<img src="../../pics//dd3b289c-d90e-44a6-a44c-4880517eb1de.png"/>
...
把一个类接口转换成另一个用户需要的接口，Adapter 模式使得原本由于接口不兼容而不能一起工作的那些类可以一起工作
...
<img src="../../pics//a6c20f60-5eba-427d-9413-352ada4b40fe.png"/>
